package com.xworkz.stream.grocery.tester;

import java.util.Arrays;
import java.util.Collection;
import java.util.Optional;

import com.xworkz.stream.grocery.dao.GroceryDAO;
import com.xworkz.stream.grocery.dao.GroceryDAOImpl;
...
public class GroceryTester {
	...
	public static void main(String[] args) {
		...
		GroceryDTO gt = new GroceryDTO("Biscuit", 45f, "Snaks", 1, true, "MariGold", "25/12/2021", "31/03/2015", true,
				true, "123456789122331");

		GroceryDTO gt1 = new GroceryDTO("Chocolate", 450f, "Snaks", 50, true, "Cadburry", "25/12/2021", "1/03/2015",
				true, true, "12311222 789122331");

		GroceryDTO gt2 = new GroceryDTO("ToorDal", 25f, "Pulse", 1, true, "Goodness", "5/12/2021", "3/03/2015", true,
				true, "12345678914569");

		GroceryDTO gt3 = new GroceryDTO("oil", 55f, "cookingOil", 1, true, "SunFlower", "13/12/2020", "1/03/2017", true,
				true, "1234567891223233");
		...
		Optional<GroceryDTO> dtofound1 = list.stream().filter(q -> q.getManufactureDate().equals("13/12/2020"))
				.findAny();
		...
		Optional<GroceryDTO> dtofound2 = list.stream().filter(s -> s.getExpireDate().equals("13/12/2020")).findAny();
