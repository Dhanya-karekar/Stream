package com.xworkz.stream.example;
...
public class StreamsExample {
	...
	public static void main(String[] args) {
		...
		Collection<String> watchBrand = Arrays.asList("Sonata", "FastTrack", "Titan", "Daniel Wellington", "Chumbak",
				"DressBerry");
		...
		System.out.println("#######################################################################");
		List<String> brand = Arrays.asList("Sonata", "FastTrack", "Titan", "Daniel Wellington", "Chumbak", "DressBerry");
